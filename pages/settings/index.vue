...
<template>
  <UDashboardPanelContent class="pb-24">
    <UDashboardSection :title="$t('settings.theme.title')" :description="$t('settings.theme.description')">
      <template #links>
    ...
    <UDashboardSection :title="$t('settings.language.title')" :description="$t('settings.language.description')">
      <template #links>
        <LanguageSelect color="gray" />
      </template>
    </UDashboardSection>
